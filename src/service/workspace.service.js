...
class WorkspaceService {
    ...
    async addMember({workspace_id, member_id, owner_id}) {
        ...
        const is_member = await workspaceRepository.isUserMemberOfWorkspace({workspace_id, member_id})
    ...
    async createWorkspace({ name, owner_id }) {
        ...
        const workspace_id = await workspaceRepository.createWorkspace({ name, owner_id })
